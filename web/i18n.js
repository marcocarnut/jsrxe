...
export const STRINGS = {
  en: {
    ...
    crackReady:       "Ready — paste target hashes and press Start (▶).",
    crackComing:      "GPU pipeline is wired in the next step.",
    crackStarting:    "starting…",
    crackCompiling:   "compiling WGSL…",
    crackDone:        "Done",
    crackStopped:     "Stopped",
    crackPaused:      "paused — press ▶ to resume",
    crackCPUfallback: "Running on the CPU (slower)",
    crackReinit:           "re-initializing…",
    crackRecovered:        "{n} GPU recoveries",
    crackCoolingCountdown: "GPU cooling down — resuming in {s}s (recovery #{n}/{m})",
    crackGpuCooldown:      "GPU cooldown (s)",
    crackGpuCooldownCap:   "cooldown cap (min)",
    crackGpuStability:     "reset after (min)",
    crackGpuMaxResets:     "max recoveries",
  ...
  pt: {
    ...
    crackReady:       "Pronto — cole os hashes-alvo e pressione Iniciar (▶).",
    crackComing:      "O pipeline de GPU entra no próximo passo.",
    crackStarting:    "iniciando…",
    crackCompiling:   "compilando WGSL…",
    crackDone:        "Concluído",
    crackStopped:     "Parado",
    crackPaused:      "pausado — toque em ▶ para retomar",
    crackCPUfallback: "Rodando na CPU (mais lento)",
    crackReinit:           "reinicializando…",
    crackRecovered:        "{n} recuperações da GPU",
    crackCoolingCountdown: "GPU resfriando — retomando em {s}s (recuperação #{n}/{m})",
    crackGpuCooldown:      "resfriamento da GPU (s)",
    crackGpuCooldownCap:   "limite do resfriamento (min)",
    crackGpuStability:     "zerar após (min)",
    crackGpuMaxResets:     "recuperações máx.",
