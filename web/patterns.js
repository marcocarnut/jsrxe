...
export const BUILTIN = [
  ...
  },
  {
    ...
    note: {
      en: "A composition policy: seven lowercase/digit characters, at least one " +
          "digit. {{7!+,1}} sets that floor, with + letting lowercase soak up " +
          "the rest -- what a plain regex needs a lookahead for. And it walks " +
          "minimal-compliance-first, so this mostly-letters-plus-a-digit " +
          "password sits near the front of the 70 billion and cracks at once.",
      pt: "Uma política de composição: sete caracteres minúsculos ou dígitos, " +
          "com pelo menos um dígito. O {{7!+,1}} fixa esse piso, e o + deixa as " +
          "minúsculas absorverem o resto -- o que uma regex comum só faz com " +
          "lookahead. E percorre em conformidade-mínima-primeiro, então esta " +
          "senha (quase tudo letra, um dígito) fica perto do início dos 70 " +
          "bilhões e cai de imediato."
    }
  },
  {
    id: "bf-passphrase",
